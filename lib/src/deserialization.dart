...
dynamic _getValueFromTranSection(String s){
  var idx1 = s.indexOf(_TSD);
  var idx2 = s.indexOf(_TSD, idx1 + 1);
...
dynamic _processStringBackToListOrSet(dynamic col, String s){
  ...
  while(start < s.length){
    var dataLengthStartIdx = s.indexOf(_TSD, start) + 1;
    var dataLengthEndIdx = s.indexOf(_TSD, dataLengthStartIdx);
